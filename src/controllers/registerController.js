  ...
  renderRegister(req, res) {
    ...
    processRegister: (req, res) => {
        ...
        if (errors.errors.length != 0)
            res.render ("pages/register", { title: "register" , errors: errors.errors, old: req.body});
        else {
            ...
            res.render("pages/login", {usuarioRegistrado: "Se registró correctamente", title: "login"});
          }
        },
    }
